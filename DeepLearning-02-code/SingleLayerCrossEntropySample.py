...
inner_product = InnerProductLayer(name='ip1', output_neurons=10)
...
#softmax.input_tensors_names = ['Z']
#softmax.output_tensors_names = ['Y']

#cross_entropy = CrossEntropyLossLayer()
#cross_entropy.input_tensors_names = ['Y']
#cross_entropy.output_tensors_names = ['L']
